...
//수정 성공하면? 실패하면? -> boardList.. 혹은 다르게도
	...
	/* SELECT b.board_no boardNo, b.board_title boardTitle, f.board_file_no boardFileNo, f.origin_filename originFilename 
		...
		*mysql delete
		...
		where board_file_no=? and board_no=?;
	...
	*/			
	...
	String delSql = "DELETE FROM board_file WHERE board_title = ?";
	PreparedStatement boardStmt = conn.prepareStatement(delSql);
